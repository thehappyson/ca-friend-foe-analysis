...
ANNOTATION_FILES = [
    ...
    #("Heimkehr", "./data/annotated/kevin/heimkehr_annotation.csv"), # fehlt noch volständig
    ("Feinde", "./data/annotated/kevin/feinde_annotations.csv"), # fehlen frames
    ("Triumph des Willens", "./data/annotated/kevin/triumph_des_willens_annotations.csv"), #nicht alle annotated
    ("Hans Westmar", "./data/annotated/kevin/hans_westmar_annotations.csv"), # fehlen frames
    ("Jud Süß", "./data/annotated/kevin/jud_suess_annotations.csv") #fehlen frames
]

# Name to fill in for annotations with missing annotator
DEFAULT_ANNOTATOR_NAME = "Kevin"
...
LABELS = ["us", "them", "neutral"]
LABEL_COLORS = {"us": "#4C9BE8", "them": "#E85454", "neutral": "#999999"}
